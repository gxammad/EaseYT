...
import SearchPage from './pages/SearchPage'; // Keep SearchPage as it's likely needed immediately
import OverviewPage from './pages/OverviewPage'; // Keep Overview as it's likely needed immediately
// Lazy load pages
